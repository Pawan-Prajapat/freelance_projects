...
import {
    add_banner, add_discount, get_banner, get_discount, get_topSlide,
    delete_banner, update_topSlide, discount_status , discount_value
} from "../controllers/bannerAndSliderDiscountControllers.js";
...
router.route("/update_discount").patch(discount_status);
router.route("/discount_value").post(discount_value);
