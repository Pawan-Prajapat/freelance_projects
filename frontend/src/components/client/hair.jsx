...
export default function Hair(props) {
  ...
  if (props.which === "hair") {
    selectedHariData = myName.data.filter(element => element.categroies && element.categroies.indexOf("hair") !== -1);
    console.log(selectedHariData);
  } else if (props.which === "hennas") {
    selectedHariData = myName.data.filter(element => element.categroies && element.categroies.indexOf("hennas") !== -1);
  } else if (props.which === "hairMask") {
    selectedHariData = myName.data.filter(element => element.categroies && element.categroies.indexOf("hairMask") !== -1);
  } else if (props.which === "hairEssentialOil") {
    selectedHariData = myName.data.filter(element => element.categroies && element.categroies.indexOf("hairEssentialOil") !== -1);
  } else {
    selectedHariData = myName.data.filter(element => element.categroies && (element.categroies.indexOf("hair") !== -1 || element.categroies.indexOf("hennas") !== -1 || element.categroies.indexOf("hairMask") !== -1 || element.categroies.indexOf("hairEssentialOil") !== -1));
  }
