...
function Categories() {
    ...
    const selectedcategroiesData = myName.data.data.filter((element) => element.which === "subCategroies");
        ...
        <>
            ...
            <div>
                {selectedcategroiesData.length > 0 ? (
                    ...
                    <div>No sub-categroies Add sub-categroies</div>
                )}
            </div>
        </>
    );
